...
# cbib images on GHCR. NB: ghcr-only for now to test the registry; the local-sif override
# (use sif_dir/*.sif if present) will be re-added later.
_bayes_sif = "docker://ghcr.io/cbib/deconvolista-bayesspace:latest"
_visu_sif  = "docker://ghcr.io/cbib/deconvolista-visu:latest"
